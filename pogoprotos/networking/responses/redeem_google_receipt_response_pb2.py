...
# source: pogoprotos/networking/responses/redeem_google_receipt_response.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/responses/redeem_google_receipt_response.proto',
  package='pogoprotos.networking.responses',
  syntax='proto3',
  serialized_pb=_b('\nDpogoprotos/networking/responses/redeem_google_receipt_response.proto\x12\x1fpogoprotos.networking.responses\"\xbc\x01\n\x1bRedeemGoogleReceiptResponse\x12S\n\x06result\x18\x01 \x01(\x0e\x32\x43.pogoprotos.networking.responses.RedeemGoogleReceiptResponse.Status\x12\x19\n\x11transaction_token\x18\x02 \x01(\t\"-\n\x06Status\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x0b\n\x07\x46\x41ILURE\x10\x02\x62\x06proto3')
)
...
_REDEEMGOOGLERECEIPTRESPONSE_STATUS = _descriptor.EnumDescriptor(
  name='Status',
  full_name='pogoprotos.networking.responses.RedeemGoogleReceiptResponse.Status',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_REDEEMGOOGLERECEIPTRESPONSE = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.responses.RedeemGoogleReceiptResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.RedeemGoogleReceiptResponse.result', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='transaction_token', full_name='pogoprotos.networking.responses.RedeemGoogleReceiptResponse.transaction_token', index=1,
...
RedeemGoogleReceiptResponse = _reflection.GeneratedProtocolMessageType('RedeemGoogleReceiptResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.redeem_google_receipt_response_pb2'
