...
# source: pogoprotos/networking/responses/get_combat_challenge_response.proto
...
_GETCOMBATCHALLENGERESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='pogoprotos.networking.responses.GetCombatChallengeResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_sym_db.RegisterEnumDescriptor(_GETCOMBATCHALLENGERESPONSE_RESULT)


_GETCOMBATCHALLENGERESPONSE = _descriptor.Descriptor(
  name='GetCombatChallengeResponse',
  full_name='pogoprotos.networking.responses.GetCombatChallengeResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='pogoprotos.networking.responses.GetCombatChallengeResponse.result', index=0,
...
_GETCOMBATCHALLENGERESPONSE.fields_by_name['result'].enum_type = _GETCOMBATCHALLENGERESPONSE_RESULT
...
GetCombatChallengeResponse = _reflection.GeneratedProtocolMessageType('GetCombatChallengeResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.get_combat_challenge_response_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.responses.GetCombatChallengeResponse)
  ))
_sym_db.RegisterMessage(GetCombatChallengeResponse)
